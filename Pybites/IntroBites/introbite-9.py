...
def get_workout_motd(day):
    ...
    #     return INVALID_DAY
    # elif day in WORKOUT_SCHEDULE and day == "Monday":
    #     TRAIN = 'Go train {}'.format(WORKOUT_SCHEDULE[day])
    #     return TRAIN
    # elif day in WORKOUT_SCHEDULE and day == "Tuesday":
    #     TRAIN = 'Go train {}'.format(WORKOUT_SCHEDULE[day])
    #     return TRAIN
    # elif day in WORKOUT_SCHEDULE and day == "Wednesday":
    #     TRAIN = 'Go train {}'.format(WORKOUT_SCHEDULE[day])
    #     return TRAIN
    # elif day in WORKOUT_SCHEDULE and day == "Thursday":
    #     TRAIN = 'Go train {}'.format(WORKOUT_SCHEDULE[day])
    #     return TRAIN
    # elif day in WORKOUT_SCHEDULE and day == "Friday":
    #     TRAIN = 'Go train {}'.format(WORKOUT_SCHEDULE[day])
    #     return TRAIN
    # elif day in WORKOUT_SCHEDULE and day == "Saturday":
    #     return CHILL_OUT
    # elif day in WORKOUT_SCHEDULE and day == "Sunday":
    #     return CHILL_OUT
    # pass
    if day not in WORKOUT_SCHEDULE:
        print(INVALID_DAY)
